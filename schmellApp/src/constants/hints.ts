export default {
  ...
  JHA: 'Drikk om du har gjort tingen som blir nevnt. Hvis det er kun en som drikker, er det en "Schmell" og personen må fortelle historien.',
  ...
  SED: 'Svar på spørsmålet som blir stilt, eller bevar hemmeligheten ved å ta antall slurker som vist på telefonen.',
